...
public class PivotIOSim extends PivotIOReal {
    ...
    final MomentOfInertia m = KilogramSquareMeters
            .of(Math.pow((2.0 * Math.PI), 2) * (1. / 16.) * 9.4);
    final Voltage v = Volts.of(PivotConstants.frictionVoltage);
    final SimMotorConfigs config = new SimMotorConfigs(DCMotor.getKrakenX60Foc(2), PivotConstants.reduction, m,
            v);
    ...
    public void updateSimState() {
        ...
        double rotorPosition = simPositionMeters / PivotConstants.reduction;
