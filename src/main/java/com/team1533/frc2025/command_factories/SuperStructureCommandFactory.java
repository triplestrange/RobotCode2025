...
public class SuperStructureCommandFactory {
  ...
  public static final Trigger wristBlockFunnel = new Trigger(() -> false);

  public static final Trigger funnelBlockElevator = new Trigger(() -> false);

  public static final Trigger elevatorBlockWristDown = new Trigger(() -> false);

  public static final Trigger wristBlockElevatorUp = new Trigger(() -> false);

  public static final Trigger wristCollision = new Trigger(() -> false);

  public static final Trigger funnelBlockWrist = new Trigger(() -> false);

  public static final Trigger elevatorZeroRequest =
      new Trigger(container.getElevatorSubsystem()::isZerod).onFalse(zeroElevator());
  ...
  public static Command zeroElevator() {
    ...
    return moveWristOnly(0.3)
        .onlyIf(wristBlockFunnel)
        .andThen(moveFunnelOnly(0.25))
        .onlyIf(funnelBlockElevator)
        .andThen(
            new ParallelCommandGroup(ArmFactory.hold(), WristFactory.hold(), FunnelFactory.hold())
                .raceWith(ElevatorFactory.resetZero()));
  }
