...
public class ElevatorCommands {
    public static Command moveToPosition(ElevatorSubsystem elevator, double height) {
        return new InstantCommand(() -> elevator.setTargetPosition(height), elevator);
    }

    public static Command liftThenDrop(ElevatorSubsystem elevator, double liftHeight) {
