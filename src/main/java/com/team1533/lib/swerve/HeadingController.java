...
public class HeadingController {
  ...
  public HeadingController() {
    ...
    m_PIDController.setTolerance(
        DriveConstants.RotationConfigs.kSwerveHeadingControllerErrorTolerance);
    ...
    switch (m_HeadingControllerState) {
      ...
      case SNAP:
        m_PIDController.setPID(
            DriveConstants.RotationConfigs.gainsSnap.kP(),
            DriveConstants.RotationConfigs.gainsSnap.kI(),
            DriveConstants.RotationConfigs.gainsSnap.kD());
        break;
      case MAINTAIN:
        m_PIDController.setPID(
            DriveConstants.RotationConfigs.gainsMaintain.kP(),
