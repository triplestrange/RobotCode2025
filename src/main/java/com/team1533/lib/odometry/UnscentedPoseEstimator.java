...
public class UnscentedPoseEstimator {
  ...
  private final TimeInterpolatableBuffer<Pose2d> m_odom_to_robot =
  ...
  private final InterpolatingTreeMapBuffer<InterpolatingDouble, Pose2d> m_field_to_odom =
      new InterpolatingTreeMapBuffer<>(kObservationBufferSize);
  ...
  public Optional<VisionUpdate> getLatestVisionUpdate() {
    if (mLatestVisionUpdate != null) return Optional.of(mLatestVisionUpdate);
  ...
  public Optional<Pose2d> sampleAt(double timestampSeconds) {
    ...
    Transform2d visionUpdate =
        new Transform2d(
            ...
            m_field_to_odom
                .getInterpolated(new InterpolatingDouble(timestampSeconds))
                .getRotation());
